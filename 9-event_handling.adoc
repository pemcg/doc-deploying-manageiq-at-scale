...
[source,pypy] 
----
vmdb_production=# select event_name,provider_model,enabled ⏎
from blacklisted_events;
               event_name               |    provider_model            | enabled
----------------------------------------+---------------------------------------
 storageAccounts_listKeys_BeginRequest  | ...Azure::CloudManager       | t
 storageAccounts_listKeys_EndRequest    | ...Azure::CloudManager       | t
 identity.authenticate                  | ...Openstack::CloudManager   | t
 scheduler.run_instance.start           | ...Openstack::CloudManager   | t
 scheduler.run_instance.scheduled       | ...Openstack::CloudManager   | t
 scheduler.run_instance.end             | ...Openstack::CloudManager   | t
 ConfigurationSnapshotDeliveryCompleted | ...Amazon::CloudManager      | t
 ConfigurationSnapshotDeliveryStarted   | ...Amazon::CloudManager      | t
 ConfigurationSnapshotDeliveryFailed    | ...Amazon::CloudManager      | t
 UNASSIGNED                             | ...Redhat::InfraManager      | t
 USER_REMOVE_VG                         | ...Redhat::InfraManager      | t
 USER_REMOVE_VG_FAILED                  | ...Redhat::InfraManager      | t
 USER_VDC_LOGIN                         | ...Redhat::InfraManager      | t
 USER_VDC_LOGOUT                        | ...Redhat::InfraManager      | t
 USER_VDC_LOGIN_FAILED                  | ...Redhat::InfraManager      | t
 AlarmActionTriggeredEvent              | ...Vmware::InfraManager      | t
 AlarmCreatedEvent                      | ...Vmware::InfraManager      | t
 AlarmEmailCompletedEvent               | ...Vmware::InfraManager      | t
 AlarmEmailFailedEvent                  | ...Vmware::InfraManager      | t
 AlarmReconfiguredEvent                 | ...Vmware::InfraManager      | t
 AlarmRemovedEvent                      | ...Vmware::InfraManager      | t
 AlarmScriptCompleteEvent               | ...Vmware::InfraManager      | t
 AlarmScriptFailedEvent                 | ...Vmware::InfraManager      | t
 AlarmSnmpCompletedEvent                | ...Vmware::InfraManager      | t
 AlarmSnmpFailedEvent                   | ...Vmware::InfraManager      | t
 AlarmStatusChangedEvent                | ...Vmware::InfraManager      | t
 AlreadyAuthenticatedSessionEvent       | ...Vmware::InfraManager      | t
 EventEx                                | ...Vmware::InfraManager      | t
 UserLoginSessionEvent                  | ...Vmware::InfraManager      | t
 UserLogoutSessionEvent                 | ...Vmware::InfraManager      | t
 scheduler.run_instance.start           | ...Openstack::NetworkManager | t
 scheduler.run_instance.scheduled       | ...Openstack::NetworkManager | t
 scheduler.run_instance.end             | ...Openstack::NetworkManager | t
 ConfigurationSnapshotDeliveryCompleted | ...Amazon::NetworkManager    | t
 ConfigurationSnapshotDeliveryStarted   | ...Amazon::NetworkManager    | t
 ConfigurationSnapshotDeliveryFailed    | ...Amazon::NetworkManager    | t
(36 rows)
----
...
----
    :event_catcher:
      ...
      :event_catcher_openstack:
        ...
        :amqp_recovery_attempts: 4
        :ceilometer:
          :event_types_regex: "\\A(?!firewall|floatingip|gateway|net|port|router| ⏎
             subnet|security_group|vpn)"
