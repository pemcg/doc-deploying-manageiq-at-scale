...
[source,pypy] 
----
INFO -- : MIQ(MiqServer#validate_worker) \
Worker [ManageIQ::Providers::Vmware::InfraManager::RefreshWorker] \
with ID: [1000000258651], PID: [17949], \
GUID: [77362eba-c179-11e6-aaa4-00505695be62] \
...
[source,pypy] 
----
WARN -- : MIQ(MiqServer#validate_worker) \
Worker [MiqEmsMetricsProcessorWorker] with ID: [1000000259290], PID: [15553], \
GUID: [40698326-c18a-11e6-aaa4-00505695be62] \
...
[source,pypy] 
---- 
... Q-task_id([log_status]) MIQ(MiqServer.log_system_status) [EVM Server (2768)] \
MiqQueue count for state=["dequeue"] by zone and role: \
...
[source,pypy] 
---- 
... Q-task_id([log_status]) MIQ(MiqServer.log_system_status) [EVM Server (2768)] \ MiqQueue count for state=["error"] by zone and role: \
...
[source,pypy] 
---- 
... Q-task_id([log_status]) MIQ(MiqServer.log_system_status) [EVM Server (2768)] \ MiqQueue count for state=["ready"] by zone and role: \
...
[width="100%",cols="^17%,^23%,^23%,^12%,^13%",options="header",align="center"]
|=======================================================================
