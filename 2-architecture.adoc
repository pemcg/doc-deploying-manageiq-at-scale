...
[NOTE]
====
Although the terms _provider_ and _external management system (EMS)_ are often used interchangeably, there is an inportant distinction. The _provider_ is the CloudForms component, whereas the _EMS_ is the managed entity that the provider connects to, such as the VMware vCenter
====
