...
:parse_vc_data=>0.15207147598266602, :parse_targeted_inventory=>0.15630817413330078, \
...
[source,pypy] 
----
... MIQ(ManageIQ::Providers::Vmware::InfraManager::Refresher#preprocess_targets) \
Escalating to full refresh for EMS: [vCenter6], id: [1000000000002].
----
